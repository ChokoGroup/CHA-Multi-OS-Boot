...
if [ -f "/.choko/Run Lakka 1080p.nfo" ]
then
  rm "/.choko/Run Lakka 1080p."*
  echo "Menu option \"Run Lakka (1080p)\" deleted (Lakka system files and partition were not deleted)."
else
  echo "\"/.choko/Run Lakka 1080p.*\" not found."
fi
sleep 3
