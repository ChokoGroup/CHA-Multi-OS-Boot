...
if [ -f "/.choko/Run Batocera 1080p.nfo" ]
then
  rm "/.choko/Run Batocera 1080p."*
  echo "Menu option \"Run Batocera (1080p)\" deleted (Batocera system files and partition were not deleted)."
else
  echo "\"/.choko/Run Batocera 1080p.*\" not found."
fi
sleep 3
